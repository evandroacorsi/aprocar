...
{
    $dir = rtrim(sys_get_temp_dir(), DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'aprocar-rate-limit';
...
{
    return rtrim(api_env('SITE_URL', api_env('VITE_SITE_URL', 'https://www.aprocar.org.br')), '/');
}
